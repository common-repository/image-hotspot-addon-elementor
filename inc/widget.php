...
class Wfe_Image_Hotspot_Addon extends Widget_Base {
				...
				foreach ( $settings['hot_spots'] as $index => $item ) :
                    ...
                    <span <?php echo $this->get_render_attribute_string( 'hotspot' . $i ); ?>>
                        ...
                        if ( $item['hotspot_type'] == 'icon' ) {
	                        printf( '<span class="wfe-hotspot-icon-wrap"><span class="wfe-hotspot-icon wfe-tooltip %1$s"></span></span>', esc_attr( $item['hotspot_icon'] ) );
                        }
...
Plugin::instance()->widgets_manager->register_widget_type( new Wfe_Image_Hotspot_Addon() );